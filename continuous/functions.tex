...
\begin{defn}
    ...
    \end{equation}
    and say that $f$ \emph{maps} $D$ to $R$.\footnote{Sets and set builder notation are explained in more detail in \chref{ch:sets}.} Slightly more formally, functions require
    four properties:
    \begin{enumerate}
