...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth]{continuous/trig/basictrig.eps}
  \end{center}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    \subfigure[The Pythagorean Theorem states that the sum of the areas square $a$ and square $b$ is equal to the area of square $c$.]{
      \includegraphics[width=0.4\textwidth]{continuous/functions/pyth.eps}
      \label{fig:pyth}
    }
    \hspace{0.1\textwidth}
    \subfigure[The equation for a unit circle is $a^2+b^2=1$. This creates a circle with a radius of $1$.]{
      \includegraphics[width=0.4\textwidth]{continuous/functions/unitcirc.eps}
