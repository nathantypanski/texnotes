...
Instead, we use \definitionintro{predicate logic}, which allows us to make general
...
\begin{defn}
A \definition{term}{term} is a variable.
\end{defn}

\begin{defn}
A \definition{propositional function}{propositional function},
$P(x)$, is a
...
The \textbf{existential quantification}\index{existential quantification} of $P(x)$ is the proposition
