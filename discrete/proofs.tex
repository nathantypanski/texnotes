...
A \def{fact} or \def{result} is the simplest type of statement we might
prove. Sometimes proofs are required, but more often they are simply
demonstrated, implied, or obvious.

\def{Theorems}{theorem} are where proofs start to become important. They are the
...
\def{lemma} is a less important theorem, often used in proving
...
A \def{direct proof} starts with known facts, and the statement we are trying
