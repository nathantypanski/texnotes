...
\usepackage[a5paper, twoside]{geometry}  % set the margins to 1in on all sides usepackage
...
\newcommand{\definition}[2]{\mbox{\textbf{#1}}\index{#2}}
...
\newenvironment{exemplify}{\begin{center}}{\end{center}}
