...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth]{continuous/limits/infinited.eps}
  \end{center}
...
\begin{ex}
  ...
  \begin{sol}
    \begin{figure}[h]
      \begin{center}
        \includegraphics[width=0.4\textwidth]{continuous/limits/4xmx2.eps}
      \end{center}
...
\begin{ex}
  ...
  \begin{sol}
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{continuous/limits/sintheta.eps}
      \end{center}
