...
The more common way is to use \textbf{set builder notation}\index{set builder notation}.
...
The set $\set{ x \big| P(x)}$ is called the \textbf{extension}\index{extension}
of the predicate $P$.
