...
\textbf{conjecture}\index{conjecture}.

A \textbf{fact}\index{fact} or \textbf{result}\index{result} is the simplest type of statement we might
prove. Sometimes proofs are required, but more often they are simply
demonstrated, implied, or obvious.

\textbf{Theorems}\index{theorem} are where proofs start to become important. They are the
foundations of complex mathematical logic. Some theorems are
less important than others, and we call these \emph{lemmata}.\index{lemmata} A
...
\textbf{corollaries}\index{corollary}, theorems that follow
...
A \textbf{direct proof}\index{direct proof} starts with known facts, and the statement we are trying
